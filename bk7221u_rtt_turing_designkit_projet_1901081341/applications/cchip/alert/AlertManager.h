...
extern AlertManager *alertmanager_new(void *data);
...
#else
extern list_t *alertmanager_get_activealerts(AlertManager *alertManager);
#endif
...
extern void alertmanager_stop_active_alert(AlertManager *alertManager);
...
extern AlertHandler *alertmanager_get_alerthandler(AlertManager *alertManager);

extern void *alertmanager_get_data(AlertManager *alertManager);
