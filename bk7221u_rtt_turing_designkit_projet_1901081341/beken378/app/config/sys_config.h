...
/*section 16-----*/
#define CFG_BEKEN_FLASH                            0
#define CFG_XTX_25F16B_FLASH                       0
#define CFG_XMC_25QH32B_FLASH                      0
