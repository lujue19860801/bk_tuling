...
{
    {0x1C7016, 1, 2,  0, 0, 2, 0x1F, 0x1F           , 0x00, 0, 0, 0xA5, 0x01}, //en_25qh32b
    {0x0B4014, 2, 2, 14, 1, 2, 0x1F, 0x1F           , 0x00, 9, 1, 0xA0, 0x01}, //xtx_25f08b
    {0x0B4015, 2, 2, 14, 1, 2, 0x1F, 0x1F           , 0x00, 9, 1, 0xA0, 0x01}, //xtx_25f16b
    {0x0B4016, 2, 2, 14, 1, 2, 0x1F, 0x1F           , 0x00, 9, 1, 0xA0, 0x01}, //xtx_25f16b
    {0xC84015, 2, 2, 14, 1, 2, 0x1F, 0x02 | (1 << 8), 0x00, 9, 1, 0xA0, 0x01}, //gd_25q16c
    {0x204016, 2, 2, 14, 1, 2, 0x1F, 0x1F           , 0x00, 9, 1, 0xA0, 0x01}, //xmc_25qh32b
    {0xC22315, 1, 2,  0, 0, 2, 0x0F, 0x0F           , 0x00, 6, 1, 0xA5, 0x01}, //mx_25v16b
    {0x000000, 2, 2,  0, 0, 2, 0x1F, 0x00           , 0x00, 0, 0, 0x00, 0x01}, //default
};
#else
static const flash_config_t flash_config[] =
{
    {0x1C7016, 1, 2,  0, 0, 2, 0x1F, 0x1F           , 0x00, 0, 0, 0xA5, 0x02}, //en_25qh32b
    {0x0B4014, 2, 2, 14, 1, 2, 0x1F, 0x1F           , 0x00, 9, 1, 0xA0, 0x02}, //xtx_25f08b
    {0x0B4015, 2, 2, 14, 1, 2, 0x1F, 0x1F           , 0x00, 9, 1, 0xA0, 0x02}, //xtx_25f16b
    {0x0B4016, 2, 2, 14, 1, 2, 0x1F, 0x1F           , 0x00, 9, 1, 0xA0, 0x02}, //xtx_25f16b
    {0xC84015, 2, 2, 14, 1, 2, 0x1F, 0x1F           , 0x00, 9, 1, 0xA0, 0x02}, //gd_25q16c
    {0x204016, 2, 2, 14, 1, 2, 0x1F, 0x1F           , 0x00, 9, 1, 0xA0, 0x02}, //xmc_25qh32b
    {0xC22315, 1, 2,  0, 0, 2, 0x0F, 0x0F           , 0x00, 6, 1, 0xA5, 0x02}, //mx_25v16b
    {0x000000, 2, 2,  0, 0, 2, 0x1F, 0x00           , 0x00, 0, 0, 0x00, 0x01}, //default
};
#endif
...
{
    return flash_current_config->flash_lan_mode;
}
...
static void set_flash_protect(PROTECT_TYPE type)
{
	...
	switch (type)
	{
		...
		case ALL:
			param = flash_current_config->protect_all & 0xff;//protect all
...
{
	//if((mode==0) && ((flash_id & 0xff00ff) == FLASH_XTX_16M))
	//	return;
...
void flash_init(void)
{
    ...
    flash_set_line_mode(flash_current_config->flash_lan_mode);
...
UINT32 flash_write(char *user_buf, UINT32 count, UINT32 address)
{
    ...
    if(4 == flash_current_config->flash_lan_mode)
    {
