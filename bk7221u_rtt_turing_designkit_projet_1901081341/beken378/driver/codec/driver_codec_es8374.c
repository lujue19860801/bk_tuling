...
static void gpio_output(UINT32 index, UINT32 val)
{
    UINT32 reg_val;
    volatile UINT32 *gpio_cfg_addr;
...
{
	gpio_config(I2C_CLK,0);
	gpio_config(I2C_DAT,0);
	CLK_OUTPUT_HIGH();
	DATA_OUTPUT_HIGH();
	es8374_codec_i2c_delay(1);
