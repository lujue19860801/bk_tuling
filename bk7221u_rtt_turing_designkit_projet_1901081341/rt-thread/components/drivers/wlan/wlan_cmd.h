...
#define WCMD_SUCCESS            0
#define WCMD_FAILURE            1

#define SSID_MAX_COUNT          128
#define PWS_MAX_COUNT           64
#define MAX_AP_LIST             5
#define SSIDKEYPREFIX	        "ssid "
#define PASSWDKEYPREFIX         "passwd "
...
int try_enter_factory_mode(void);
